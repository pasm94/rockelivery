...
config :rockelivery, RockeliveryWeb.Auth.Guardian,
  issuer: "rockelivery",
  secret_key: "J9IzxDgz2B60mY5AlLGLYEvZGTLut3aeE65rnkmgANTrZutc4tpdYB46QAHlPldf"
...
config :rockelivery, RockeliveryWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "KIt4Ys5uvLYIVMNkUFKROZ/455gSsyM0kc135m8qUSsTWMiIATnuiodX9kKTfVKl",
  render_errors: [view: RockeliveryWeb.ErrorView, accepts: ~w(json), layout: false],
  pubsub_server: Rockelivery.PubSub,
  live_view: [signing_salt: "1MKwBQmF"]
